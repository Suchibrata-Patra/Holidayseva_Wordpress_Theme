...
<div style="width: 100%; display: flex; justify-content: center;">
  ...
  <div style="width: 88%; padding: 60px 20px; box-sizing: border-box;">
    ...
    <div 
      id="search-results" 
      style="position: absolute;left: 50%; transform: translateX(-50%); width: 88%;background: #fff; border-radius: 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.4); z-index: 1000; display: none; max-height: 80vh; overflow-y: auto; padding: 24px;">
    </div>
  </div>
</div>
