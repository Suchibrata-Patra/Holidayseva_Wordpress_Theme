    ...
    <div class="main-content">
        ...
        <div id="reviews">
            <div style="display:flex;width:300px;">
                ...
                <button type="button" id="add-review" style="border-radius:50px;background-color:green;color:white;border:none;margin-top:5%;margin-bottom:5%;margin-left:20px;">Add +</button>
            </div>
