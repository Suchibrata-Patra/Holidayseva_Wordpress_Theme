    ...
    <div class="main-content">
        ...
        <div id="reviews">
            ...
            <div id="reviews-container">
                ...
                <div class="review-set" data-index="<?php echo $index; ?>" style="border:2px solid blue;margin-top:10px;border-radius:4px;padding:5px;">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                addReviewButton.addEventListener('click', function () {
                    ...
                    const reviewHTML = `
            <div class=\"review-set\" data-index=\"${index}\" style=\"border:2px solid blue;margin-top:10px;border-radius:4px;padding:5px;\">
