    ...
    <div class="main-content">
        ...
        <div id="reviews">
            ...
            <div id="reviews-container">
                ...
                <div class="review-set" data-index="<?php echo $index; ?>" style="border:2px solid #2980b9;margin-top:10px;border-radius:4px;padding:5px;background-color:#F2EFE7;">
                    ...
                    <button type="button" class="remove-review" style="border-radius:50px;background-color:red;color:white;border:none;">Remove</button>
                </div>
                <?php endforeach; ?>
            </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                addReviewButton.addEventListener('click', function () {
                    ...
                    const reviewHTML = `
            <div class=\"review-set\" data-index=\"${index}\" style=\"border:2px solid #2980b9;margin-top:10px;border-radius:4px;padding:5px;\">
