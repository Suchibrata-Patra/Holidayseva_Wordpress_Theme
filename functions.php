...
function display_tour_meta_box($post) {
    ...
    <!-- Sidebar -->
<div class="sidebar">
    <a href="javascript:void(0)" class="active" onclick="toggleCollapse('tour_form')">Tour Details</a>
    <a href="javascript:void(0)" onclick="toggleCollapse('seo_form')">SEO Settings</a>
</div>

<!-- Main Content -->
<div class="content">
    <div id="tour_form" class="collapse" style="display: block;">
        <h3>Tour Details</h3>
        <form method="post" action="">
            ...
            <div class="form-group">
                ...
                <input type="number" name="tour_price" class="form-control" />
            </div>

            <div class="form-group">
                <label for="tour_availability">Availability:</label>
                <input type="text" name="tour_availability" class="form-control" />
            </div>
            ...
            <div class="form-group">
                ...
                <button type="button" id="tour_cover_images_button" class="btn mt-2">Select Images</button>
            </div>
        </form>
    </div>
...
// Media uploader (Replace with appropriate WordPress method for media handling)
document.getElementById('tour_cover_images_button').addEventListener('click', function() {
    alert("This button should trigger a WordPress media uploader. Implement the appropriate code here.");
});
