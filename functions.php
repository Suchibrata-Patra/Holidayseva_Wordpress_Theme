...
function display_tour_meta_box($post) {
    ...
    <div class="col-md-3">
        <div class="list-group">
            <a href="#tour_form" class="list-group-item list-group-item-action active" data-toggle="collapse" aria-expanded="true" aria-controls="tour_form">
                Tour Details
            </a>
            <a href="#seo_form" class="list-group-item list-group-item-action" data-toggle="collapse" aria-expanded="false" aria-controls="seo_form">
                SEO Settings
            </a>
        </div>
    </div>
    ...
    <div class="col-md-9">
        <div id="tour_form" class="collapse show">
            ...
            <form method="post" action="">
                ...
                <!-- Add other fields for the Tour form -->
            </form>
        </div>
        ...
        <div id="seo_form" class="collapse">
            ...
            <form method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="focus_keyword" value="" class="form-control" />
                </div>
            </form>
        </div>
    </div>
