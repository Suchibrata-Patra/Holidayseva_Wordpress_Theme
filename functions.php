...
function save_tour_meta($post_id) {
    ...
    // RankMath's focus keyword
    if (isset($_POST['_rank_math_focus_keyword'])) {
        update_post_meta($post_id, '_rank_math_focus_keyword', sanitize_text_field($_POST['_rank_math_focus_keyword']));
    }
}
...
// Register the custom table creation hook
