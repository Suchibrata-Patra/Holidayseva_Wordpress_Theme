...
// Function to create the custom table for tourings
function create_custom_table() {
    global $wpdb;
    
    $table_name = $wpdb->prefix . 'custom_tourings'; // Name of your custom table
    ...
    $sql = "CREATE TABLE $table_name (
        ...
        touring_date datetime DEFAULT CURRENT_TIMESTAMP NOT NULL,
