<?php get_header(); ?>
    ...
    <div class="image-container" style="display: flex;">
        <img src="https://s0.2mdn.net/simgad/60204998891146136sss82" alt="Skeleton Loader" class=" skeleton_loader" style="background-color:rgb(248, 248, 248);border-radius: 10px;">
        <img src="https://s0.2mdn.net/simgad/6020499889114613682" alt="Skeleton Loader" class=" skeleton_loader">
        <img src="https://s0.2mdn.net/simgad/6020499889114613682" alt="Skeleton Loader" class="image_styling_custom_class skeleton_loader">
    </div>
    <style>
    ...
    <script>
        window.addEventListener('load', () => {
            ...
            const images = document.querySelectorAll('..skeleton_loader');
