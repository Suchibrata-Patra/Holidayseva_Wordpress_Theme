                ...
                <div class="travel-guide-card">
                    <a href="<?php the_permalink(); ?>" style="text-decoration:none;">
                        ...
                        <div class="related_content_card_content">
                           <span  style="background-color:#002d33;color:white;margin-left:-30px;padding:10px;padding-left:40px;">Holidayseva<span style="color:#e49b42;"> Originals</span></span>
