...
<div class="hotel-store-row">
  ...
  <button id="swipe_button" style="color:black;text-decoration:none;background-color:black;border:none;color:white;border-radius:50px;padding:10px 20px;">Swipe →</button>
