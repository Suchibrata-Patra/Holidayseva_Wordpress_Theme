...
<section class="footer_second_part"
    ...
    <div style="flex: 0 0 70%;">
        <p style="margin: 0;">&copy;
            <?php echo date('Y'); ?> <a href="<?php echo esc_url(home_url()); ?>"
                style="color:black;text-decoration:none;"><i>Holidayseva</i></a> - All rights reserved.
        </p>
    ...
    <div style="flex: 0 0 30%; display: flex; justify-content: center; gap: 10px;">
        <button aria-label="Currency: INR"
            style="padding: 8px 20px; background-color: white; border: 1px solid grey; border-radius: 50px;">₹
            INR</button>
        <button aria-label="Location: India"
...
<section class="footer_third_part"
    ...
    <div style="flex: 0 0 60%;font-weight: 200;font-size:0.9rem">
        ...
        <a href="<?php echo esc_url(home_url()); ?>" style="color:black;text-decoration:none;"><i>Holidayseva</i></a>
        makes no guarantees for availability of prices advertised on our sites and applications. Listed prices may
        require a stay of a particular length or have blackout dates, qualifications or other applicable restrictions.
        Holidayseva LLC is not responsible for any content on external web sites that are not owned or operated by
        Holidayseva.
        <br><br>
        <a href="<?php echo esc_url(home_url()); ?>" style="color:black;text-decoration:none;"><i>Holidayseva</i></a>
        LLC is not a booking agent or tour operator. When you book with one of our partners, please be sure to check
        their site for a full disclosure of all applicable fees.
    </div>
